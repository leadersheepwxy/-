...
def GaussianNB_model(block, normal, ax_val, ax_test):
    ...
    print("=========================參數最佳化=========================")
    bestValue = [bestGroup, bestAuc]
    bestValue_name = ['最佳組別:', '最佳準確率:']  #
    ...
    print(ScoresChart)
    NB_roc_val = plot_roc_curve(model, X_val, y_val, ax=ax_val, color='red')
    NB_roc_test = plot_roc_curve(model, X_testing, y_testing, ax=ax_test, color='red')
